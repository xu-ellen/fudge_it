...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'Fudge_It!123'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///C:\\Ellen\\fudge_it\\database.db' # sqlite:///database.db
...
@app.route("/form") # to join the event
def form():
